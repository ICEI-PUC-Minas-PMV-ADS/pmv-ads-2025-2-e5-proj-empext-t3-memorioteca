...
<table>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>RF-002: A aplicação deve permitir que usuários (visitantes e administradores) cadastrados realizem login</td>
  </tr>
  <tr>
    <td><strong>Passos</strong></td>
    <td>
      1. Abrir o postman.<br>
      2. Criar um POST de request para a rota /user.<br>
      3. Informar um body com nome, email e senha.<br>
    ...
    <td>
      - <strong>Nome:</strong> Nome da pessoa<br>
      - <strong>Email:</strong> Email ainda não cadastrado<br>
      - <strong>Senha:</strong> Colocar valor de senha válida
  </tr>
    <tr>
    <td><strong>Critérios de êxito</strong></td>
    <td>A API deve responder codigo 201 indicando cadastro com sucesso.</td>
  </tr>
</table>
